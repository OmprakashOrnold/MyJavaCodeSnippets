...
### Q #2) What is Spring MVC?
 ...
 Spring MVC follows the concept of Model, View, and Controller.
...
### Q #6) Explain the front controller class of Spring MVC.
 ...
 Front Controller is responsible to handle the entire incoming request of an application. In Spring MVC, dispatcher servlet acts as a front controller and handles the entire incoming requests.

### Q #7) Explain the function of @Autowired Annotation.

 The @Autowired annotation is responsible for injecting a bean by its type along with the fields and methods. Thereby helping the Spring framework in resolving and injection of collaborating beans into our bean.
...
### Q #8) What is the function of Model Attribute annotation?
 ...
 @ModelAttribute annotation plays a vital role in the Spring MVC framework. It is responsible for the binding method parameter with the respective model attribute and then shows it to the presentation page.
...
### Q #12) Why do we need View Resolver in Spring MVC and what is an internal view resolver in Spring?
 ...
 View Resolver is responsible for rendering of models in the web browser. It does not require any specific view technologies like JSP, XML, and Velocity, etc.
...
<img src="https://www.softwaretestinghelp.com/wp-content/qa/uploads/2019/02/6.jpg" alt="MarineGEO circle logo" style="height: 700px; width:700px;"/>
...
### Q #14) What is the purpose of using BindingResults?
 ...
 BindingResults is one of the interfaces in Spring that comes under the package org.Springframework.validation and is used to represent the binding results.
...
### Q #15) Explain the Model 1 and Model 2 architecture of Spring Framework.
 ...
 These are the two important design models for developing web applications.
...
### Q #18) Explain the functions of the following annotations: @Component, @Controller, @Repository, @Service.
 ...
 These are the important annotations in Spring MVC. Let’s take a look at them.
...
### Q #19) What is the role of Multipart resolver and when is it used?
 ...
 Multipart Resolver is responsible for uploading the file in a web application. Two implementations for it are commonsMultipartResolver and StandardServletMultipartResolver.

### Q #20) How does Spring MVC provide support for validation?

 Spring provides validation support in two ways – i.e Mainly by using JSR 303 annotation and Validator interface.

### Q #21) How is Localization achieved in the Spring MVC web applications?

 Spring MVC is configured with LocaleResolver for supporting both internationalization and localization. For making this possible, some beans need to be registered as mentioned below.
...
<img src="https://www.softwaretestinghelp.com/wp-content/qa/uploads/2019/02/9.png" alt="MarineGEO circle logo" style="height: 700px; width:700px;"/>
...
### Q #23) What is the role of web.xml in Spring MVC and where is it located?
 ...
 In web.xml, we configure the ContextLoaderListner. When we deploy the application, an instance is created by the Servlet container for ContextLoaderListner and then it leads to loading of the webApplicationContext.

### Q #24) Describe some return types of the controller method.

 Some of the important return types of the controller methods include String, void, view, ModelAndView, Model, Map, HttpHeaders, etc.

### Q #25) On what basis is a view chosen in the rendering phase?

 The ViewResolver in MVC architecture is responsible for choosing the required view.
...
### Q #26) What is the main difference between @Requestparam and @PathVariable annotation?
 ...
 These annotations are used for fetching information and data from an URL.
