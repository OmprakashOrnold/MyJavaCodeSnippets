# Interview Questions and Answe

[What-are-the-different-ways-of-implementing-thread](#q.-What-are-the-different-ways-of-implementing-thread?)

## Q. What are the states in the lifecycle of a Thread?
A java thread can be in any of following thread states during it’s life cycle i.e. New, Runnable, Blocked, Waiting, Timed Waiting or Terminated. These are also called # Multithreading Interview Questions and Answers
...
<div align="right">
    <b><a href="#">↥ back to top</a></b>
</div>life cycle events of a thread in java. 
